...
class AppointmentController {
    ...
    async store(req, res) {
        ...
        */
        const checkIsProviderTheSameUserOfUserId = provider_id == req.userId;
        if (checkIsProviderTheSameUserOfUserId) {
            return res.status(401).json({error: 'Providers cannot create appointments'});
        }
        /**
         * Check if provider_id is a provider
        */
